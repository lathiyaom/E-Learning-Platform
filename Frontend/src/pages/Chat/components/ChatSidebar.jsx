...
const ChatSidebar = ({
  ...
  const handleStartChat = (e) => {
    e.preventDefault();
    if (selectedContact && onStartConversation) {
      onStartConversation(selectedContact, subject);
      setSelectedContact("");
      setSubject("");
    }
  };
            ...
            >
              ...
              <div className="flex-1 min-w-0">
                <div className="flex justify-between items-baseline mb-0.5">
                  ...
                  <span className="text-[10px] font-bold text-slate-400 dark:text-slate-500 ml-2 shrink-0">
                    {chat.time}
                  </span>
                </div>
            ...
            <form onSubmit={handleStartChat} className="p-6 space-y-4">
              <div>
                <label className="block text-xs font-bold text-slate-600 dark:text-slate-300 mb-2 uppercase tracking-wider">
                  Select {user?.userType === "student" ? "Teacher" : "Student"}
                </label>
                <select
                ...
                >
                  <option value="">
                    Choose a{" "}
                    {user?.userType === "student" ? "teacher" : "student"}...
                  </option>
