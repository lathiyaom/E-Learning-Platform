...
import SuperAdminAnalytics from "./pages/Dashboard/SuperAdmin/Analytics.jsx";
import CreateAnnouncement from "./pages/Dashboard/SuperAdmin/CreateAnnouncement.jsx";
...
function App() {
  ...
  const [validateToken, { isLoading: isValidating }] =
      ...
      <DarkModeProvider>
        <BrowserRouter>
          <Routes>
            ...
            />
            <Route
              path="/teacher/invitation/:token/:action"
              element={<InvitationAction />}
            />
            ...
            />
            <Route
              path="/admin/teacher-marketplace"
              element={
                <ProtectedRoute requiredRole="admin">
                  <TeacherMarketplace />
                </ProtectedRoute>
            ...
            />
            <Route
              path="/student/conducted-lectures"
              element={
                <ProtectedRoute requiredRole="student">
                  <StudentConductedLectures />
                </ProtectedRoute>
              }
            />
            <Route
              path="/student/upcoming-lectures"
              element={
                <ProtectedRoute requiredRole="student">
                  <StudentUpcomingLectures />
                </ProtectedRoute>
              }
            />
            <Route
