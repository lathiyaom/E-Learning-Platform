...
files.forEach(file => {
  ...
  if (fs.existsSync(fullPath)) {
    ...
    // Core blues to primary (which is the golden #ecb613 from the config)
    content = content.replace(/bg-blue-600/g, 'bg-primary dark:bg-premium-gold');
    content = content.replace(/hover:bg-blue-700/g, 'hover:scale-105 hover:brightness-110'); // using brightness/scale for better golden buttons
